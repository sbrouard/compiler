...
#line 240 "grammar.y" /* yacc.c:1646  */
    {
  if ((yyvsp[-2].t) == VIDE && set__find((yyvsp[-1].t), VAR))
    yyerror("Erreur : variable de type void !\n");
  else if (set__size((yyvsp[-1].t)) > 1 && set__find((yyvsp[-1].t), FONCTION))
